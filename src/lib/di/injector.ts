 ...
 * ### Example
 *
 * {@example core/lib/ts/injector_spec.ts region='Injector'}
 *
 * `Injector` returns itself when given `Injector` as a token:
 * {@example core/lib/ts/injector_spec.ts region='injectInjector'}
 *
 * @stable
 */
...
function tryResolveToken(token: any, record: Record | undefined, records: Map<any, Record>, parent: Injector,
