...
export interface InjectDecorator {
   ...
   * ### Example
   *
   * {@example core/lib/ts/metadata_spec.ts region='Inject'}
   *
   ...
   * ### Example
   *
   * {@example core/lib/ts/metadata_spec.ts region='InjectWithoutDecorator'}
   *
   * @stable
   */
  (token: any): any;
...
export interface OptionalDecorator {
   ...
   * ### Example
   *
   * {@example core/lib/ts/metadata_spec.ts region='Optional'}
   *
   * @stable
   */
  (): any;
...
export interface InjectableDecorator {
   ...
   * ### Example
   *
   * {@example core/lib/ts/metadata_spec.ts region='Injectable'}
   *
   * {@link Injector} will throw an error when trying to instantiate a class that
   * does not have `@Injectable` marker, as shown in the example below.
   *
   * {@example core/lib/ts/metadata_spec.ts region='InjectableThrows'}
   *
   * @stable
   */
  (): any;
...
export interface SelfDecorator {
   ...
   * ### Example
   *
   * {@example core/lib/ts/metadata_spec.ts region='Self'}
   *
   * @stable
   */
  (): any;
...
export interface SkipSelfDecorator {
   ...
   * ### Example
   *
   * {@example core/lib/ts/metadata_spec.ts region='SkipSelf'}
   *
   * @stable
   */
  (): any;
...
export interface HostDecorator {
   ...
   * ### Example
   *
   * {@example core/lib/ts/metadata_spec.ts region='Host'}
   *
   * @stable
   */
  (): any;
